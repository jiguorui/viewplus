...
struct DefaultFontNames
{
    DefaultFontNames()
    {
        ...
        {
            defaultSans     = L"ËÎÌå";//"Verdana";
            defaultSerif    = L"ÑÅºÚ";//"Times New Roman";
            defaultFixed    = L"ËÎÌå";//"Lucida Console";
            defaultFallback = L"ËÎÌå";//"Tahoma";  // (contains plenty of unicode characters)
        }
    }
